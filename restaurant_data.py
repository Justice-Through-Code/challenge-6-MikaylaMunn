...
def favorite_restaurant():
    ...
    #    }
    favorite_restaurant['name'] = input('Enter Favorite Restaurant: ')
    favorite_restaurant['address'] = input('Enter the Address: ')
    favorite_restaurant['favorite_dish'] = input('Enter Favorite Dish')
...
def clean_print():
    ...
    for i in restaurant_1:
        print(f'{i}: {restaurant_1[i]}')
